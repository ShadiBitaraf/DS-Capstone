...
cv, cv_df = count_vectorization.get_bow(traindata, "review", 3, 4, 0.01, 0.9) #change min_df and max_df in the future
...
topicwords = [] #change this to instead be stored in the df
